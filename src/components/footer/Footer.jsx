...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      href: "https://linkedin.com/in/amanyelfawey",
    },
  ];
            ...
            <div className="flex gap-4">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className="p-3 bg-slate-800 rounded-lg text-slate-400 hover:text-cyan-400 hover:bg-slate-700 transition-all duration-300 hover:scale-110"
        ...
        <div className="border-t border-slate-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-slate-400 text-sm">
              © {currentYear} Amany Elfawey. All rights reserved.
            </div>
          </div>
        </div>
      </div>
